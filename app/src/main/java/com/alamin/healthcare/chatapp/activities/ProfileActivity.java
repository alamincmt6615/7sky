...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void chooseimage(){
        ...
        Toast.makeText(ProfileActivity.this, "plz choose image first", Toast.LENGTH_SHORT).show();
    }
...
//
        if (requestCode == 1 && resultCode == RESULT_OK) {
            ...
            final StorageReference file = FirebaseStorage.getInstance().getReference().child("profile_images").child(currentUserId + ".jpg");
            ...
            final StorageReference file = FirebaseStorage.getInstance().getReference().child("profile_covers").child(currentUserId + ".jpg");
            file.putFile(url).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    if (task.isSuccessful()) {
...
//        storageReference = storage.getReference().child("profile_pic");
        ...
        if (pic_uri != null){
            ...
            final StorageReference ref = FirebaseStorage.getInstance().getReference().child("profile_images").child(currentUserId + ".jpg");
